	  ...
	  <div class='login_fields'>
	   <form action="enter.php" name="form_register" method="post">
	    ...
	    <div class='login_fields__user'>
	      ...
	      <input name="account" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value=""/>
		...
		<div align="center">
	    <div class='login_fields__submit' style="display:inline">
...
var canGetCookie = 0;//是否支持存储Cookie 0 不支持 1 支持
	    ...
	    $('input[name="account"],input[name="password"]').keyup(function () {
	    ...
	    layui.use('layer', function () {
	        ...
	        $('input[type="button"]').click(function () {
	            var login = $('input[name="acount"]').val();
